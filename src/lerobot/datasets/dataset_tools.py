        ...
        for (src_chunk_idx, src_file_idx), episodes_in_file in tqdm(
            ...
            if all_in_file_set == episodes_to_keep_set:
                ...
                for old_idx in sorted_keep_episodes:
                    ...
                    calc_len = to_frame - from_frame
                    if src_ep["length"] != calc_len:
                        logging.warning(
                            f"Episode {old_idx} length mismatch: metadata={src_ep['length']} vs video_calc={calc_len}. "
                            f"Using metadata length."
                        )
